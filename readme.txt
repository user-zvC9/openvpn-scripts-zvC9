...
(these scripts don't install OpenVPN/OpenSSL and don't work under Windows. But if
you can copy secret files securely from Linux to Windows (like if you are running
...
change extension of .conf files to ".ovpn"))
